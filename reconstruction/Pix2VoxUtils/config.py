...
__C.DATASETS.SHAPENET.RENDERING_PATH        = 'C:/Internship/Benchmarking-2D-to-3D-Converters/ShapeNet/ShapeNetRendering/%s/%s/rendering/%02d.png'
# __C.DATASETS.SHAPENET.RENDERING_PATH      = '/home/hzxie/Datasets/ShapeNet/PascalShapeNetRendering/%s/%s/render_%04d.jpg'
__C.DATASETS.SHAPENET.VOXEL_PATH            = 'C:/Internship/Benchmarking-2D-to-3D-Converters/ShapeNet/ShapeNetVox32/%s/%s/model.binvox'
